...
import { EXIT_GAME, GAME_ADDED, GAME_ENDED, GAME_OVER, GAME_TIME, INIT_GAME, JOIN_ROOM, MOVE, USER_TIMEOUT, type GameResult, type Metadata, type Result } from "../types";
import { movesAtom, userSelectedMoveIndexAtom } from "@repo/store/chessBoard";
import { useRecoilValue, useSetRecoilState } from "recoil";
import { ChessBoard, isPromoting } from "../components/chess/ChessBoard2";
import MoveSound from '/move.wav'
import { GAME_JOINED } from "./Game";
import GameEndModal from "../components/chess/GameEndModal";
import { UserAvatar } from "../components/Ui/UserAvatar";
import { Button } from "../components/Button";
import { Waitopponent } from "../components/chess/WaitOpponent";
import { ShareGame } from "../components/chess/ShareGame";
import ExitGameModal from "../components/chess/ExitGameModal";
import MovesTable from "../components/chess/MovesTable";
    ...
    socket.onmessage = function(event){
      ...
      switch (message.type){
        ...
        case INIT_GAME:
          ...
          setGameMetadata({
            blackPlayer: message.payloand.blackPlayer,
            ...
            <div className="rounded-md pt-2 bg-bgAuxiliary3 flex-1 overflow-auto h-[95vh] overflow-y-scroll no-scrollbar">
              {!started ? (
                ...
                <div className="p-8 flex justify-center w-full">
                  <ExitGameModal onClick={() => handleExit()} />
                </div>
              )}
              <div>
                <MovesTable />
